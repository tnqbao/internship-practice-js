export function createSearchButton() {
    ...
    button.innerHTML = `
        <svg fill="#000000" width="100px" height="100px" viewBox="-4.83 -4.83 38.08 38.08" id="_02_-_Search_Button" data-name="02 - Search Button" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="2.757031">
