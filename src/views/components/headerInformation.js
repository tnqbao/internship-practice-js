...
export function createHeaderInformation() {
    ...
    const email = customizeElement(document.createElement('a'), {
        ...
        id: 'email',
        innerHTML: `
            <svg fill="#ffffff" width="30px" height="30px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
